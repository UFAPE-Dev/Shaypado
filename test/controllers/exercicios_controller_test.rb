...
class ExerciciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercicio" do
    assert_difference("Exercicio.count") do
      post exercicios_url, params: { exercicio: { academium_id: @exercicio.academium_id, calorias: @exercicio.calorias, descricao: @exercicio.descricao, dificuldade: @exercicio.dificuldade, quantidade: @exercicio.quantidade, tipo: @exercicio.tipo, titulo: @exercicio.titulo } }
    end
  ...
  test "should update exercicio" do
    patch exercicio_url(@exercicio), params: { exercicio: { academium_id: @exercicio.academium_id, calorias: @exercicio.calorias, descricao: @exercicio.descricao, dificuldade: @exercicio.dificuldade, quantidade: @exercicio.quantidade, tipo: @exercicio.tipo, titulo: @exercicio.titulo } }
