...
class AlunoTest < ActiveSupport::TestCase
  ...
  test "criar aluno sem academia" do
    aluno = Aluno.new(nome: 'Josefa', endereco: 'Rua Josefa', cep: '111111111', cpf: '11111111111', data_nascimento: Date.today, contato: '11111111111', senha: '111111', academium_id: '')
    assert_not aluno.save, "Não é possível salvar um aluno sem academia"
  end

  test "criar aluno sem senha" do
    aluno = Aluno.new(nome: 'Josefa', endereco: 'Rua Josefa', cep: '111111111', cpf: '11111111111', data_nascimento: Date.today, contato: '11111111111', senha: '', academium_id: '1')
