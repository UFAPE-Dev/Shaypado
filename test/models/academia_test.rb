...
class AcademiaTest < ActiveSupport::TestCase
  ...
  test "criar academia sem dados" do
    academia = Academium.new(nome: '', email: '', cnpj: '', contato: '', ativo: '')
  ...
  test "salvar academia sem proprietário" do
    academia = Academium.new(nome: 'Academiaaa', email: 'academia@gmail.com', cnpj: '11111111111111', contato: '87981025842', ativo: true, proprietario_id: '')
  ...
  test "salvar academia sem cnpj e endereço" do
    academia = Academium.new(nome: 'Academia', email: 'academia@gmail.com', cnpj: '', contato: '87981025842', ativo: 'true')
    endereco = Endereco.new(logradouro: '', cep: '')
    academia.endereco = endereco
