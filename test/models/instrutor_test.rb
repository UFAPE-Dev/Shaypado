...
class InstrutorTest < ActiveSupport::TestCase
  ...
  test "salvar instrutor sem dados" do
    instrutor = Instrutor.new(nome: '', cpf: '', data_de_nascimento: '', contato_telefone: '', horas_de_trabalho: '', email: '', password: '', academium_id: '')
    assert_not instrutor.save, "Não é possível salvar um instrutor sem dados"
  end

  test "salvar um instrutor sem academia" do
    instrutor = Instrutor.new(nome: 'Marcelino', cpf: '11111111111', data_de_nascimento: Date.yesterday, contato_telefone: '11111111111', horas_de_trabalho: Time.now, email: 'email@email.com', password: '111111', academium_id: '')
  ...
  test "salvar um instrutor sem email e senha" do
    instrutor = Instrutor.new(nome: 'Marcelino', cpf: '11111111111', data_de_nascimento: Date.yesterday, contato_telefone: '11111111111', horas_de_trabalho: Time.now, email: '', password: '', academium_id: 1)
    endereco = Endereco.new(cep: '11111111', logradouro: 'Rua Josefa')
    instrutor.endereco = endereco
