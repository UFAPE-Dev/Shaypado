class Instrutor < ApplicationRecord
  ...
  validates :data_de_nascimento, presence: true, comparison: {less_than: Time.zone.today, greater_than: Date.new(1850, 1, 1)}
  validates :contato_telefone, presence: true, length: { is: 11 }, format: { with: /\A[0-9]+\z/, message: "Somente números" }
  validates :horas_de_trabalho, presence: true
