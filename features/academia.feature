Feature: academia
  ...
  Scenario: cadastrar academia
    ...
    When eu preencho os dados para o proprietario com cpf '12345678900' os campos nome 'Academia Teste', email 'academia@email.com', endereco 'Avenida Bom Pastor, 123, Boa Vista, Garanhuns - PE', cep '55385000', cnpj '62302383000100' e contato '81999999999'
  ...
  Scenario: visualizar academia na pagina de academias
    Given existe um proprietario com nome 'Proprietário', endereco 'Test de endereco', cep '55385000', cpf '12345678900', data_nascimento '10/10/1990', contato '21547896322', email 'email@email.com' e password '123123123'
    And esse proprietario de cpf '12345678900' tem academia que possui nome 'Academia Teste', email 'academia@email.com', endereco 'Avenida Bom Pastor, 123, Boa Vista, Garanhuns - PE', cep '55385000', cnpj '62302383000100' e contato '81999999999'
  ...
  Scenario: editar academia
    ...
    When eu edito os campos com os novos valores nome 'Academia Novo', email 'academia_novo@email.com', endereco 'Avenida Bom Pastor, 123, Boa Vista, Garanhuns - PE', cep '55385000', cnpj '62302383000100' e contato '81999999988'
